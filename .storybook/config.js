...
// This is to utilized to override the window.___navigate method
// Gatsby defines and uses to report what path a Link would be taking
// us to if it wasn't inside a storybook
