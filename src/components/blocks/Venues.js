...
const Venue = () => {
  return (
    <div id="venue" class="venues text-center">
      <h2 class="block__heading--dark">The Venues</h2>
      <div class="venue">
        <div class="venue__title">
          City College, Sunday Jun 10
        </div>
        <div class="venue__for">
          Workshops
        </div>
        ...
        <div class="venue__container">
          <div class="venue__map">
            <div class="map" data-long="40.6373756" data-lat="22.9370313"></div>
          </div>
      ...
      <div class="venue">
        ...
        <div class="venue__container">
          ...
          <div class="venue__map">
            <div class="map" data-long="40.6252233" data-lat="22.9495758"></div>
          </div>
        </div>
      </div>
    </div>

    {% include blocks/plan.html %}
  );
};
